...
namespace demetrio77\smartadmin\components\ReCaptcha;
...
class ReCaptcha extends InputWidget
{
    ...
    /** @var string The id of parent captcha DOM element*/
    public $id;
    /**
    ...
    protected function customFieldPrepare()
    {
        ...
        if (Yii::$app->request->isAjax) {
            $view->registerJs("setTimeout(function(){ grecaptcha.render('".$this->id."',{sitekey:'".Yii::$app->reCaptcha->siteKey."'});}, 100);", $view::POS_END);
        }
